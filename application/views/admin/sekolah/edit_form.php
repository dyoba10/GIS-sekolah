  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="card mb-3">
        ...
        <a href="<?php echo site_url('admin/sekolah/') ?>"><i class="fas fa-arrow-left"></i></a>
        </div>
        <div class="card-body">
            <form action="<?php base_url('admin/sekolah/edit') ?>" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id" value="<?php echo $sekolah->id_sekolah?>" />
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="old_image" value="<?php echo $sekolah->gambar ?>" />    
					<div class="invalid-feedback">
                ...
                <div class="form-group">
					<label for="name">Alamat*</label>
						<textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>"
								 name="alamat" placeholder="Alamat"><?php echo $sekolah->alamat ?></textarea>
					<div class="invalid-feedback">
                ...
                <div class="form-group">
					<label for="name">Deskripsi*</label>
						<textarea class="form-control <?php echo form_error('Deskripsi') ? 'is-invalid':'' ?>"
								 name="deskripsi" placeholder="Deskripsi"><?php echo $sekolah->deskripsi ?></textarea>
					<div class="invalid-feedback">
        ...
        <div class="form-group">
					...
					<input class="form-control <?php echo form_error('website') ? 'is-invalid':'' ?>"
						type="text" name="website" min="0" placeholder="website" value="<?php echo $sekolah->website ?>" />
					<div class="invalid-feedback">
          ...
          <div class="form-group">
					...
					<input class="form-control <?php echo form_error('kontak') ? 'is-invalid':'' ?>"
						type="text" name="kontak" min="0" placeholder="kontak" value="<?php echo $sekolah->kontak ?>" />
					<div class="invalid-feedback">
          ...
          <div class="form-group">
					...
					<input class="form-control <?php echo form_error('latitude') ? 'is-invalid':'' ?>"
						type="text" name="latitude" min="0" placeholder="Latitude" value="<?php echo $sekolah->latitude ?>" />
					<div class="invalid-feedback">
          ...
          <div class="form-group">
					...
					<input class="form-control <?php echo form_error('longitude') ? 'is-invalid':'' ?>"
						type="text" name="longitude" min="0" placeholder="Longitude" value="<?php echo $sekolah->longitude ?>" />
					<div class="invalid-feedback">
